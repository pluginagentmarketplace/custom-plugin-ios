...
This guide provides comprehensive documentation for the **ios-data** skill in the custom-plugin-ios plugin.
...
```bash
# Invoke the skill
claude "ios-data - [your task description]"

# Example
claude "ios-data - analyze the current implementation"
```
...
def implement_ios_data(input_data):
    """
    Implement ios-data functionality.
