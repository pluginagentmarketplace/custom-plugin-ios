...
This guide provides comprehensive documentation for the **ios-networking** skill in the custom-plugin-ios plugin.
...
```bash
# Invoke the skill
claude "ios-networking - [your task description]"

# Example
claude "ios-networking - analyze the current implementation"
```
...
def implement_ios_networking(input_data):
    """
    Implement ios-networking functionality.
