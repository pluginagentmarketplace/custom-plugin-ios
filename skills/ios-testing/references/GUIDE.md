...
This guide provides comprehensive documentation for the **ios-testing** skill in the custom-plugin-ios plugin.
...
```bash
# Invoke the skill
claude "ios-testing - [your task description]"

# Example
claude "ios-testing - analyze the current implementation"
```
...
def implement_ios_testing(input_data):
    """
    Implement ios-testing functionality.
